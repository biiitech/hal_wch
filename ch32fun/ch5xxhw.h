...
typedef struct {
	...
	vu32 EDGE;
	vu32 IF;
	CH5XX_GPIO_PORT_TypeDef PORT[2];
} CH5XX_GPIO_TypeDef;

#define GPIO ((CH5XX_GPIO_TypeDef*)0x40001090)
...
#define  RB_FCR_TRIG_01     0x00                      // RW, UART receiver FIFO trigger level: 1 byte
#define  RB_FCR_TRIG_02     0x40                      // RW, UART receiver FIFO trigger level: 2 bytes
#define  RB_FCR_TRIG_04     0x80                      // RW, UART receiver FIFO trigger level: 4 bytes
#define  RB_FCR_TRIG_07     0xC0                      // RW, UART receiver FIFO trigger level: 7 bytes
#define UART_LCR            3
