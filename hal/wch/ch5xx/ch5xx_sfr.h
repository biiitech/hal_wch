/*
 * ch5xxhw_registers_only.h
 * Auto-generated: Contains only register and bitfield macro definitions from ch5xxhw.h
 *
 * This file is intended for use as a hardware abstraction layer (HAL) register definition header.
 * All enums, structs, and unrelated macros have been omitted.
 */

#ifndef CH5XXHW_REGISTERS_ONLY_H
#define CH5XXHW_REGISTERS_ONLY_H
...
#define AFIO ((CH5XX_AFIO_TypeDef*)0x40001018)
...
#define RB_FCR_FIFO_TRIG_MASK 0x03
#define RB_FCR_FIFO_TRIG_POS 6
#define  RB_FCR_TRIG_01     0x0                      // RW, UART receiver FIFO trigger level: 1 byte
#define  RB_FCR_TRIG_02     0x1                      // RW, UART receiver FIFO trigger level: 2 bytes
#define  RB_FCR_TRIG_04     0x2                      // RW, UART receiver FIFO trigger level: 4 bytes
#define  RB_FCR_TRIG_07     0x3                      // RW, UART receiver FIFO trigger level: 7 bytes
#define UART_LCR            3
#define  RB_LCR_WORD_SZ     0x03                      // RW, UART word bit length: 00-5bit, 01-6bit, 10-7bit, 11-8bit
#define RB_LCR_WORD_SZ_MASK 0x03
#define RB_LCR_WORD_SZ_POS  0
...
#define  RB_LCR_PAR_MOD_ODD 0x00                      // RW, UART parity mode: odd parity
#define  RB_LCR_PAR_MOD_EVN 0x10                      // RW, UART parity mode: even parity
#define  RB_LCR_PAR_MOD_MRK 0x20                      // RW, UART parity mode: mark parity
#define  RB_LCR_PAR_MOD_SPC 0x30                      // RW, UART parity mode: space parity
...
#define  RB_IIR_INT_MASK    0x0E                      // RO, UART interrupt flag bit mask
#define  RB_IIR_P0_LINE_ERR 0x06                      // RO, UART interrupt by receiver line status
#define  RB_IIR_P1_RX_RDY   0x04                      // RO, UART interrupt by receiver line status
#define  RB_IIR_P2_RX_TOUT  0x0C                      // RO, UART interrupt by receiver fifo timeout
#define  RB_IIR_P3_TX_EMP   0x02                      // RO, UART interrupt by THR empty
...
#define UART1 ((CH5XX_UART_TypeDef *)BA_UART)
#define UART2 ((CH5XX_UART_TypeDef *)BA_UART2)
#define UART3 ((CH5XX_UART_TypeDef *)BA_UART3)
...
#define I2C_CTLR1_PE          0x0001                    // RW, Peripheral enable
#define I2C_CTLR1_SMBUS       0x0002                    // RW, SMBUS mode: 0=I2C mode, 1=SMBUS mode
#define I2C_CTLR1_SMBTYPE     0x0008                    // RW, SMBus type: 0=Device, 1=Host
#define I2C_CTLR1_EBARP       0x0010                    // RW, ARP enable
#define I2C_CTLR1_ENPEC       0x0020                    // RW, PEC ebable
#define I2C_CTLR1_ENGC        0x0040                    // RW, General call enable
#define I2C_CTLR1_NOSTRETCH   0x0080                    // RW, Clock stretching disable (Slave mode)
#define I2C_CTLR1_START       0x0100                    // RW, Start generation: master mode: 0=no start, 1=repeated start; slave mode: 0=no start, 1=start at bus free
#define I2C_CTLR1_STOP        0x0200                    // RW, Stop generation: master mode: 0=no stop, 1=stop after the current byte transfer or after the current Start condition is sent; slave mode: 0=no stop, 1=Release the SCL and SDA lines after the current byte transfer
#define I2C_CTLR1_ACK         0x0400                    // RW, Acknowledge enable
#define I2C_CTLR1_POS         0x0800                    // RW, Acknowledge/PEC Position (for data reception)
#define I2C_CTLR1_PEC         0x1000                    // RW, Packet error checking: 0=No PEC transfer, 1=PEC transfer (in Tx or Rx mode)
#define I2C_CTLR1_ALERT       0x2000                    // RW, SMBus alert: 0=Releases SMBA pin high, 1=Drives SMBA pin low.
#define I2C_CTLR1_SWRST       0x8000                    // RW, Software reset
#define I2C_CTLR2_FREQ        0x003F                    // RW, Peripheral clock frequency, The minimum allowed frequency is 2 MHz,the maximum frequency is 36 MHz
#define I2C_CTLR2_ITERREN     0x0100                    // RW, Error interrupt enable
#define I2C_CTLR2_ITEVTEN     0x0200                    // RW, Event interrupt enable
#define I2C_CTLR2_ITBUFEN     0x0400                    // RW, Buffer interrupt enable
#define I2C_STAR1_SB          0x0001                    // RW0, Start bit flag (Master mode)
#define I2C_STAR1_ADDR        0x0002                    // RW0, Address sent (master mode)/matched (slave mode) flag
#define I2C_STAR1_BTF         0x0004                    // RO, Byte transfer finished flag
#define I2C_STAR1_ADD10       0x0008                    // RO, 10-bit header sent flag (Master mode)
#define I2C_STAR1_STOPF       0x0010                    // RO, Stop detection flag (slave mode)
#define I2C_STAR1_RXNE        0x0040                    // RO, Data register not empty flag (receivers)
#define I2C_STAR1_TXE         0x0080                    // RO, Data register empty flag (transmitters)
#define I2C_STAR1_BERR        0x0100                    // RW0, Bus error flag
#define I2C_STAR1_ARLO        0x0200                    // RW0, Arbitration lost flag (master mode)
#define I2C_STAR1_AF          0x0400                    // RW0, Acknowledge failure flag
#define I2C_STAR1_OVR         0x0800                    // RW0, Overrun/Underrun flag
#define I2C_STAR1_PECERR      0x1000                    // RW0, PEC Error flag in reception
#define I2C_STAR1_TIMEOUT     0x4000                    // RW0, Timeout or Tlow error flag
#define I2C_STAR1_SMBALERT    0x8000                    // RW0, SMBus alert flag
#define I2C_STAR2_MSL         0x0001                    // RO, Mode statu: 0=Slave mode, 1=Master mode
#define I2C_STAR2_BUSY        0x0002                    // RO, Bus busy flag
#define I2C_STAR2_TRA         0x0004                    // RO, Trans flag: 0=data bytes received, 1=data bytes transmitted
#define I2C_STAR2_GENCALL     0x0010                    // RO, General call address (Slave mode) received flag
#define I2C_STAR2_SMBDEFAULT  0x0020                    // RO, SMBus device default address (Slave mode) received flag
#define I2C_STAR2_SMBHOST     0x0040                    // RO, SMBus host header (Slave mode) received flag
#define I2C_STAR2_DUALF       0x0080                    // RO, Dual flag (Slave mode): 0=Received address matched with OAR1, 1=Received address matched with OAR2
#define I2C_STAR2_PECX        0xFF00                    // RO, Packet error checking register
#define I2C_CKCFGR_CCR        0x0FFF                    // RW, Controls the SCL clock in Fm/Sm mode (Master mode)
#define I2C_CKCFGR_DUTY       0x4000                    // RW, Fm mode duty cycle: 0=L/H=2, 1=L/H=16/9
#define I2C_CKCFGR_FS         0x8000                    // RW, I2C master mode selection: 0=standard mode, 1=fast mode
...
#define SYS_SAFE_ACCESS(a)                                                     \
  {                                                                            \
    R8_SAFE_ACCESS_SIG = SAFE_ACCESS_SIG1;                                     \
    R8_SAFE_ACCESS_SIG = SAFE_ACCESS_SIG2;                                     \
    asm volatile("nop\nnop");                                                  \
    {a} R8_SAFE_ACCESS_SIG = SAFE_ACCESS_SIG0;                                 \
    asm volatile("nop\nnop");                                                  \
  }
...
#define WRITE_REG_BIT(reg, mask, set)                                          \
  ((set) ? ((reg) |= (mask)) : ((reg) &= ~(mask)));

#define WRITE_REG_BIT_SAFE(reg, mask, set)                                     \
  SYS_SAFE_ACCESS(WRITE_REG_BIT((reg), (mask), (set)))

#define WRITE_REG_BITS(reg, value, mask, pos)                                  \
  (reg) = ((reg) & ~((mask) << (pos))) | (((value) & (mask)) << (pos));

#define WRITE_REG_BITS_SAFE(reg, value, mask, pos)                             \
  SYS_SAFE_ACCESS(WRITE_REG_BITS((reg), (value), (mask), (pos)))

#define GET_REG_BITS(reg, mask, pos) (((reg) >> (pos)) & (mask));

#ifdef __cplusplus
}
#endif

#endif // CH5XXHW_REGISTERS_ONLY_H
